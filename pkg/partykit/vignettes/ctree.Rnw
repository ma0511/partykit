...
%\VignetteDepends{coin, TH.data, survival}
...
\Abstract{
  This document describes an implementation 
...
This document describes \code{partykit:ctree}, an implementation of
...
data("mammoexp", package = "party") ### TH.data

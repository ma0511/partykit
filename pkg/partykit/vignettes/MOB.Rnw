...
Pima Indian women that is provided by the UCI database \citep{mlbench2} and 
...
tests \citep{Zeileis+Hornik:2007,Zeileis:2005}. For numerical partitioning variables

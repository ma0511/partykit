...
%% header declarations
\author{Torsten Hothorn \\ \addr{Institut f\"ur Epidemiologie, Biostatistik und Pr\"avention, Universit\"at Z\"urich} \\ \email{E-mail: Torsten.Hothorn@R-project.org} \AND
        Achim Zeileis \\ \addr{Department f\"ur Statistik, Universit\"at Innsbruck} \\ \email{E-mail: Achim.Zeileis@R-project.org}}

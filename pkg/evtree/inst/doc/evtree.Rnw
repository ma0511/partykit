...
Through a global search up to $D-1$ levels (\ref{eq:globally}) the complexity
...
$r_1$ and $r_2$. Let $\mathrm{sub}1(\tilde{\theta}_i^j, r_j)$ denote the subtrees
rooted by $r_j$ ($j=1,2$). Thus, $\mathrm{sub}1(\tilde{\theta}_i^j, r_j)$ contains $r_j$, 
and its descendant nodes. Then, the complementary part of $\tilde{\theta}_{i}^j$ can be 
defined as 
$\mathrm{sub}2(\tilde{\theta}_{i}^j, r_j) =  \tilde{\theta}_{i}^j \setminus \mathrm{sub}1(\tilde{\theta}_{i}^j, r_j)$. 

After the application of the \textit{crossover} operator, the trees' parameter
spaces are given by $\tilde{\theta}_{i+1}^1= \mathrm{sub}2(\tilde{\theta}_{i}^1, r_1)
\cup \mathrm{sub}1(\tilde{\theta}_{i}^2, r_2) \setminus (v_{m_{21}}, s_{m_{21}}, ...,
v_{m_{2f}}, s_{m_{2f}})$ and $\tilde{\theta}_{i+1}^2=
\mathrm{sub}2(\tilde{\theta}_{i}^2, r_2) \cup \mathrm{sub}1(\tilde{\theta}_{i}^1, r_1)
\setminus (v_{m_{11}}, s_{m_{11}}, ..., v_{m_{1f}}, s_{m_{1f}})$. Here,
$(v_{m_{11}}, s_{m_{11}}, ..., v_{m_{1f}}, s_{m_{1f}}) \subset
\mathrm{sub}1(\tilde{\theta}_i^1, r_1)$ and   
$(v_{m_{21}}, s_{m_{21}}, ...,v_{m_{2f}}, s_{m_{2f}}) \subset \mathrm{sub}1(\tilde{\theta}_i^2, r_2)$ 
are the parameters of the invalid nodes.

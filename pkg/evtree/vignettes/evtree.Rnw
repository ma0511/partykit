...
fitness function such as the misclassificaion or error rate penalized by
...
solution competes with its most similar offspring for a place in the population)

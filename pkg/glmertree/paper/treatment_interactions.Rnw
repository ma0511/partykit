...
\verb|R| \cite{R14} was used for generation and analysis of all datasets. Two additional R packages were used: \verb|partykit| (version 1.0-2; \citeNP{HothyZeil14,ZeilyHoth08}) for the estimation of GLM trees, and \verb|lme4| (version 1.1-7; \citeNP{BateyMeac12}) for the estimation of random-effects coefficients. 
...
\begin{figure}[!ht]
\setkeys{Gin}{width=0.75\textwidth}
<<depression-glmmtree, fig=TRUE, height=4, width=6>>=
